...
export default class ProjectsCMS extends Component {
  constructor(props){
    ...
    this.overview = "I developed this website to show every project I worked on from 2018 to 2020. I can manage all information including image on the CMS made by PHP and the data is stored in MySQL. I used CSS Grid on front-end webiste and it is responsive."
    this.projectproduct = {
